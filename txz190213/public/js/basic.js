...
function showCurPos() {
    ...
    function showCurrentMap(lat, lng){
        ...
        daum.maps.event.addListener(map, 'click', function (mouseEvent) {
            console.log('clicked lat : ' + mouseEvent.latLng.getLat());
            console.log('clicked lng : ' + mouseEvent.latLng.getLng());
...
function printPostInfoPage(post) {
    ...
    postJoinContent += '<p class="postJoinViewItem"><span class="postViewItemSpan" id="postViewItemMessageSpan">메세지</span><br><span id="postViewMessage">' + message + '</span></p>';
